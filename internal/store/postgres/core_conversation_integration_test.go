...
func (integrationConversationRunner) Run(_ context.Context, request core.ModelRunRequest) (core.ModelRunResult, error) {
	...
	return core.ModelRunResult{Done: true, Message: core.Message{ID: uuid.NewString(), Role: core.RoleAssistant, Content: "ok", CreatedAt: createdAt}, TransientProviderReasoning: "private integration reasoning"}, nil
}
...
func (runner integrationConversationRunner) Stream(ctx context.Context, request core.ModelRunRequest, emit func(core.ModelDelta) error) (core.ModelRunResult, error) {
	...
	if err == nil && emit != nil {
		err = emit(core.ModelDelta{Text: result.Message.Content, ReasoningContent: result.TransientProviderReasoning})
	}
	return result, err
}
