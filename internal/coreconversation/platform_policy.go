...
When a terminal answer is possible, terminal user output must be concise Markdown. Never expose raw provider reasoning, runtime JSON, internal directives, schemas, or configuration envelopes.`
