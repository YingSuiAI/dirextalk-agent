...
func (e *TaskExecutor) RegisterHandler(kind coretask.TaskKind, handler TaskHandler) error {
	if (kind != coretask.TaskKindExtension && kind != coretask.TaskKindConversationTool && kind != coretask.TaskKindKnowledgeIndex && kind != coretask.TaskKindMemoryReconcile && kind != coretask.TaskKindAWSChange && kind != coretask.TaskKindWorkload) || handler == nil {
