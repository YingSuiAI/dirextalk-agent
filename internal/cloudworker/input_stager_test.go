...
func stagingFixture(t *testing.T, now time.Time) (Plan, Execution, LaunchPrerequisite, SourceRead) {
	...
	model := ModelAuthorization{ModelProfileID: uuid.NewString(), ModelProfileRevision: 2, Provider: "openai_compatible", Model: "gpt-test", Interface: "openai_compatible", CredentialVersion: 4, CredentialBindingDigest: digestValue("credential")}
