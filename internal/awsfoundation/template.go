...
var templateAccountReadActions = map[string]struct{}{
	...
	"ec2:DescribeSecurityGroupRules": {}, "ec2:DescribeSnapshots": {}, "ec2:DescribeSubnets": {}, "ec2:DescribeVolumes": {}, "ec2:DescribeVpcAttribute": {}, "ec2:DescribeVpcEndpoints": {}, "ec2:DescribeVpcs": {},
...
var controlObserveEC2Actions = []string{
	...
	"ec2:DescribeSubnets", "ec2:DescribeVolumes", "ec2:DescribeVpcAttribute", "ec2:DescribeVpcEndpoints", "ec2:DescribeVpcs",
	"pricing:GetProducts", "servicequotas:GetServiceQuota",
}
...
func controlPolicyFailsClosed(value any) bool {
	...
	for _, item := range statements {
		...
		for _, action := range actions {
			switch {
			case action == "cloudwatch:GetMetricStatistics" || action == "pricing:GetProducts" || action == "servicequotas:GetServiceQuota":
				if sid != "ObserveEC2" {
					return false
				}
