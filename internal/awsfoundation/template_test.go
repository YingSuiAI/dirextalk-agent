...
func TestFoundationTemplateWorkerAMIPermissionsFailClosed(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "quota readback removed", sid: "ObserveEC2", old: "- servicequotas:GetServiceQuota", new: "- pricing:GetProducts"},
		{name: "catalog price readback removed", sid: "ObserveEC2", old: "- pricing:GetProducts", new: "- cloudwatch:GetMetricStatistics"},
		{name: "quota usage readback removed", sid: "ObserveEC2", old: "- cloudwatch:GetMetricStatistics", new: "- servicequotas:GetServiceQuota"},
