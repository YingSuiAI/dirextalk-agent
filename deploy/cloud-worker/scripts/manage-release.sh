...
expected_tag_query='(.Tags|map({key:.Key,value:.Value})|from_entries) as $t | $t.DirextalkWorkerImageSchema=="1" and $t.DirextalkWorkerImageFlavor==$flavor and $t.DirextalkWorkerImageVersion=="1.1.1" and $t.DirextalkPiVersion=="0.84.4" and $t.DirextalkImageTested=="true"'
verify_output_ami() {
