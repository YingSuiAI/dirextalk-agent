# Dirextalk Worker AMI release 1.1.3
...
AWS_PROFILE=release deploy/cloud-worker/scripts/manage-release.sh publish \
  ...
  arn:aws:imagebuilder:us-east-1:123456789012:image/dirextalk-worker-cpu-1-1-3/1.1.3/1 \
...
DirextalkWorkerImageVersion=1.1.3
