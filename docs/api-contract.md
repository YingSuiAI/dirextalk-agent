...
P0 Task/Admin and P1 Runtime/planning behavior are implemented. `CloudControlService` continues to report AWS/direct-STS/Worker/Reaper capabilities as disabled. Encrypted AWS bootstrap, provider mutations, Worker control, real service deployment, and resource destruction remain P2 and must not be inferred from a successful RecipeDraft.
