...
type CoreCloudWorkerLimits struct {
	...
	MinimumRuntimeSeconds  uint64                 `protobuf:"varint,4,opt,name=minimum_runtime_seconds,json=minimumRuntimeSeconds,proto3" json:"minimum_runtime_seconds,omitempty"`
	ExpectedRuntimeSeconds uint64                 `protobuf:"varint,5,opt,name=expected_runtime_seconds,json=expectedRuntimeSeconds,proto3" json:"expected_runtime_seconds,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *CoreCloudWorkerLimits) GetMinimumRuntimeSeconds() uint64 {
	if x != nil {
		return x.MinimumRuntimeSeconds
	}
	return 0
}

func (x *CoreCloudWorkerLimits) GetExpectedRuntimeSeconds() uint64 {
	if x != nil {
		return x.ExpectedRuntimeSeconds
	}
	return 0
}
...
const file_dirextalk_agent_v1_core_cloud_worker_proto_rawDesc = "" +
	...
	"\x1ahost_network_policy_sha256\x18\f \x01(\tR\x17hostNetworkPolicySha256\"\x82\x02\n" +
	...
	"\x17minimum_runtime_seconds\x18\x04 \x01(\x04R\x15minimumRuntimeSeconds\x128\n" +
	"\x18expected_runtime_seconds\x18\x05 \x01(\x04R\x16expectedRuntimeSeconds\"@\n" +
